...
function App() {
  ...
  return (
    ...
    <p style={{fontFamily:"ProximaNova_SemiBold", fontSize:"17px", marginTop:"42px", marginBottom:"20px"}}>Protección de la Privacidad para Cualquier Dispositivo</p>
    <CardGrid />
    <h1 style={{color:"white",fontSize:"45px"}}>No guardamos tu<br/>información personal. Jamás.</h1>
    <p style={{color:"white", marginTop:"30px", marginBottom:"0", lineHeight:"1.5em", fontSize:"20px"}}>Nuestra política de privacidad es simple: No colectamos<br/>o compartimos ninguna información personal tuya.</p>
    ...
    <img src="https://duckduckgo.com/assets/onboarding/bathroomguy/1-monster-v2--pre-animation.svg" style={{marginTop: "30px", width: "55%"}}/>
    </div>
  )
}
